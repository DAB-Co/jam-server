/*
    raw_languages taken from
    https://github.com/atn832/language_picker/blob/master/lib/languages.json
*/
...
for (let i=0; i<raw_languages.length; i++) {
    iso_dict[raw_languages[i]["isoCode"]] = raw_languages[i]["name"];
}

module.exports = iso_dict;
